...
!subroutine metos3dbgc(ny, nx, nu, nb, nd, dt, q, t, y, u)!, b, d)
!subroutine metos3dbgc(ny, nx, nu, dt, q, t, y, u)!, b, d)
    implicit none
    ! input variables
    integer :: ny, nx, nu, nb, nd
    real(8)  :: dt, t, y(nx, ny), u(nu), b(nb), d(nx, nd)
    real(8), intent(inout) :: q(nx, ny)
!    real(8) :: qin(nx, ny)

    print *, ny, nx, nu, nb, nd
    print *, dt, t, y, u
    print *, b, d
    print *, q
    q = dt*y
...
!    print *, qin
    ...
    ! N model
!    call Nmodel(ny, nx, nu, dt, qin, t, y(1,1), u, b(1), b(2), d(1,1), d(1,2))
